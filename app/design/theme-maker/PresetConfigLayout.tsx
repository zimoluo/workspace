  ...
  return (
    <div className={`px-3 pb-5 pt-6 ${configStyle.grid} ${className}`}>
      ...
      <div className="flex items-center justify-center">
        <button
          onClick={close}
          className={`h-9 ${configStyle.button} rounded-full shadow-lg border-reflect-light bg-light bg-opacity-65 text-center transition-colors duration-150 ease-out hover:text-light hover:bg-saturated`}
        >
          Done
        </button>
      </div>
