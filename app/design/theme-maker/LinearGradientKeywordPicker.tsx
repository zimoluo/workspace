  ...
  return (
    <div className="w-full h-full flex items-center justify-center p-4">
      <div className="w-full h-full flex flex-col items-center justify-end gap-4">
        ...
        <div className="w-auto h-1/2 aspect-square bg-pastel bg-opacity-65 shadow-sm rounded-xl relative flex items-center justify-center">
        ...
        <div className="w-full grid grid-cols-2 gap-2">
          <div className="w-full relative">
            <select
              ...
              className={`bg-none border-none appearance-none border-0 bg-pastel bg-opacity-65 shadow-sm flex-grow w-full h-full rounded-xl pl-1.5 pr-4 py-0.5 text-start ${editorStyle.input} relative`}
            >
              <option value="left">Left</option>
              <option value="right">Right</option>
            </select>
            <div
              className="absolute right-1.5 top-1/2 -translate-y-1/2 w-2.5 h-auto aspect-square pointer-events-none select-none"
              aria-hidden="true"
            >
