  ...
  >
    ...
    <div className="h-7 flex-grow relative">
      <select
        ...
        className="bg-none border-none appearance-none border-0 bg-pastel bg-opacity-65 shadow-sm flex-grow w-full h-full rounded-lg pl-2 pr-4 py-0.5 text-start text-sm relative"
      >
...
export default function GradientInterpolationMethodEditor() {
  ...
  return (
    <div className="rounded-2xl bg-light bg-opacity-65 shadow-lg p-4 flex flex-col justify-center gap-2 h-full text-sm">
      <SelectInput
        label="Color space"
        value={colorSpace}
