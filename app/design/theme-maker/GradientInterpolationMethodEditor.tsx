  ...
  >
    ...
    <div className="h-7 flex-grow relative">
      <select
        ...
        className="bg-none border-none appearance-none border-0 bg-pastel bg-opacity-65 shadow-sm flex-grow w-full h-full rounded-xl pl-2 pr-4 py-0.5 text-start text-sm relative"
      >
