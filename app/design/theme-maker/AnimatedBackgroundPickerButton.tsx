  ...
  return (
    ...
    >
      <div
        ...
        } transition-all duration-300 ease-in-out rounded-xl w-0 h-0 select-none pointer-events-none ${
      ...
      <div
        className={`${
          animationKey
            ? pickerStyle.ring
            : "bg-pastel bg-opacity-80 border-reflect-pastel border-reflect-[2.5px]"
