...
export default function AddProfileButton() {
  ...
  return (
    <button
      ...
      className="group rounded-xl bg-pastel bg-opacity-40 backdrop-blur-lg w-16 h-auto aspect-square flex items-center justify-center shadow-md border-reflect-pastel"
    >
