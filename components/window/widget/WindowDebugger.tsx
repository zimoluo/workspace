  ...
  <div className="mb-2 relative">
    ...
    <div className="relative">
      <input
        ...
        value={value}
        onChange={onChange}
        className={`w-full py-2 px-3 border border-pastel border-opacity-15 rounded-full bg-none bg-light bg-opacity-65 placeholder:text-saturated placeholder:text-opacity-50 ${debuggerStyle.input}`}
  ...
  <div className="mb-2">
    ...
    <div className="relative group">
      <select
        ...
        onChange={onChange}
        className="w-full py-2 px-3 appearance-none border border-pastel border-opacity-15 rounded-full bg-none bg-light bg-opacity-65 relative cursor-pointer"
      >
    ...
    <div className="w-full h-full bg-widget-80 grid grid-cols-2 gap-4 p-6 overflow-auto">
        ...
        <div className="space-y-4">
          ...
          <div className="mb-2">
            ...
            <input
              ...
              disabled
              className={`w-full py-2 px-3 border border-pastel border-opacity-15 rounded-full bg-none bg-light bg-opacity-65 text-saturated ${debuggerStyle.input}`}
            />
          </div>
      ...
      <div>
        ...
        <div className="mt-8">
          ...
          <div className="p-4 border border-pastel border-opacity-15 rounded-3xl bg-none bg-light bg-opacity-65">
