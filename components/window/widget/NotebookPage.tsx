...
export default function NotebookPage() {
  ...
  return (
    <div className="w-full h-full">
      <textarea
        className={`w-full h-full border-none border-transparent rounded-2xl resize-none text-lg bg-light bg-opacity-80 shadow-lg p-4 placeholder:text-saturated placeholder:text-opacity-50 ${notebookStyle.selectedColor} ${notebookStyle.textbox}`}
