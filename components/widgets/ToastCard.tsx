...
export default function ToastCard({
  ...
  return (
    <div
      className={`rounded-full md:rounded-3xl bg-widget-70 flex border-reflect-light text-sm md:text-base ${toastStyle.sizing} px-2 py-1 md:py-1.5 shadow-lg md:shadow-xs ${className}`}
    >
